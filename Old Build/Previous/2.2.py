...
async def avvia_manutenzione(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.message.reply_text("Modalità manutenzione attivata. Le notifiche sono disattivate.")
...
async def termina_manutenzione(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.callback_query.message.reply_text("Modalità manutenzione disattivata. Le notifiche sono attivate.")
...
if __name__ == '__main__':
    ...
    loop.run_until_complete(monitoraggio())
